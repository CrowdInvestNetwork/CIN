...
Open the wallets with CrowdInvestNetwork-serivce like so:

./CrowdInvestNetwork-service -w walletA.wallet -p yourpass --rpc-password test --bind-port 8070
./CrowdInvestNetwork-service -w walletB.wallet -p yourpass --rpc-password test --bind-port 8071
