...
#define CN_CIN_PAGE_SIZE             262144
#define CN_CIN_SCRATCHPAD            262144
#define CN_CIN_ITERATIONS            131072
...
#include "hash-ops.h"
  ...
  */
  ...
  // Standard CryptoNight
  inline void cn_cin_slow_hash_v0(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 0, 0, CN_CIN_PAGE_SIZE, CN_CIN_SCRATCHPAD, CN_CIN_ITERATIONS);
  }

  inline void cn_cin_slow_hash_v1(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 1, 0, CN_CIN_PAGE_SIZE, CN_CIN_SCRATCHPAD, CN_CIN_ITERATIONS);
  }

  inline void cn_cin_slow_hash_v2(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 2, 0, CN_CIN_PAGE_SIZE, CN_CIN_SCRATCHPAD, CN_CIN_ITERATIONS);
  }

  // Standard CryptoNight Lite
  inline void cn_cin_lite_slow_hash_v0(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 0, 0, CN_CIN_PAGE_SIZE, CN_CIN_SCRATCHPAD, CN_CIN_ITERATIONS);
  }

  inline void cn_cin_lite_slow_hash_v1(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 1, 0, CN_CIN_PAGE_SIZE, CN_CIN_SCRATCHPAD, CN_CIN_ITERATIONS);
  }

  inline void cn_cin_lite_slow_hash_v2(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 2, 0, CN_CIN_PAGE_SIZE, CN_CIN_SCRATCHPAD, CN_CIN_ITERATIONS);
  }
